...
class GuestShippingInformationManagement implements \Magento\Checkout\Api\GuestShippingInformationManagementInterface
{
    ...
    public function saveAddressInformation(
        ...
        $saveAddressInformation = $this->shippingInformationManagement->saveAddressInformation(
            $quoteIdMask->getQuoteId(),
            $addressInformation
        );
        $saveAddressInformation->getTotals();
        $getTotals = $saveAddressInformation->getTotals();
        ...
        $saveAddressInformation->setTotals($getTotals);
